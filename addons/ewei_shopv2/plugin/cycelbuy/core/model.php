		...
		public function sendMessage($openid = '', $data = array(), $message_type = '')
		{
			...
			if ($message_type == TM_CYCELBUY_SELLER_DATE) {
				...
				$message = array(
					...
					'keyword1' => array('title' => '任务名称', 'value' => '修改收货时间通知', 'color' => '#000000'),
					'keyword2' => array('title' => '任务类型', 'value' => $data['nickname'] . '修改了收货时间', 'color' => '#000000'),
				...
				$message = array(
					...
					'keyword1' => array('title' => '任务名称', 'value' => '修改收货地址通知', 'color' => '#000000'),
					'keyword2' => array('title' => '任务类型', 'value' => $data['nickname'] . '修改了收货地址', 'color' => '#000000'),
					'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
					'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
					);
				$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
				...
				$message = array(
					...
					'keyword1' => array('title' => '任务名称', 'value' => '修改收货时间通知', 'color' => '#000000'),
					'keyword2' => array('title' => '任务类型', 'value' => '您的收货时间已修改', 'color' => '#000000'),
					'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
					'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
					);
				$toopenid = $openid;
				...
				$message = array(
					...
					'keyword1' => array('title' => '任务名称', 'value' => '修改收货地址通知', 'color' => '#000000'),
					'keyword2' => array('title' => '任务类型', 'value' => '您的收货地址修改已完成', 'color' => '#000000'),
					'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
					'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
					);
				$toopenid = $openid;
				...
				$message = array(
					...
					'keyword1' => array('title' => '任务名称', 'value' => '订单发货通知', 'color' => '#000000'),
					'keyword2' => array('title' => '任务类型', 'value' => '订单发货通知', 'color' => '#000000'),
					'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
					'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
					);
				$datas[] = array('name' => '订单编号', 'value' => $data['ordersn']);
